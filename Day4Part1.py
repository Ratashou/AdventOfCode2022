...
for line in file:
    ...
    if int(secondAssignment[0]) >= int(firstAssignment[0]) and int(secondAssignment[1]) <= int(firstAssignment[1]):
        totalOverlaps += 1

    elif int(firstAssignment[0]) >= int(secondAssignment[0]) and int(firstAssignment[1]) <= int(secondAssignment[1]):
        totalOverlaps += 1
